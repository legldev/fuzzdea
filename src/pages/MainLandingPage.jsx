...
const content = {
  en: {
    ...
    labsPromo: {
      ...
      title: 'We are also building a digital academy to learn programming from zero.',
      description:
        'fuzzdea labs is the education arm of the company: beginner-friendly classes, practical projects, progress tracking, and a monthly subscription model.',
      points: [
        'Beginner-first roadmap',
        'Student dashboard and progress tracking',
        'Admin backoffice for courses and students',
      ],
      cta: 'Explore fuzzdea labs',
    },
    modelsIntro: {
      eyebrow: 'Models',
  ...
  es: {
    ...
    labsPromo: {
      eyebrow: 'fuzzdea labs',
      title: 'Tambien estamos creando una academia digital para aprender programacion desde cero.',
      description:
        'fuzzdea labs es el brazo educativo de la marca: clases para principiantes, proyectos practicos, seguimiento de progreso y suscripcion mensual.',
      points: [
        'Roadmap para principiantes absolutos',
        'Panel de alumno con progreso',
        'Backoffice para cursos y estudiantes',
      ],
      cta: 'Conocer fuzzdea labs',
    },
    modelsIntro: {
      eyebrow: 'Modelos',
...
function MainLandingPage() {
  ...
  const visibleNavigation = t.navigation.filter(
    (item) => item.href !== '/labs' || featureFlags.showLabsPromoOnMainSite,
  )
  ...
  return (
    <main className="page">
      ...
      <div className="shell">
        ...
        {featureFlags.showLabsPromoOnMainSite ? (
          <section className="section" id="labs">
            <div className="section__intro">
              <p className="section__eyebrow">{t.labsPromo.eyebrow}</p>
              <h2>{t.labsPromo.title}</h2>
              <p>{t.labsPromo.description}</p>
            </div>

            <div className="cta-banner cta-banner--inline">
              <div>
                <ul className="feature-list feature-list--compact">
                  {t.labsPromo.points.map((item) => (
                    <li key={item}>{item}</li>
                  ))}
                </ul>
              </div>
